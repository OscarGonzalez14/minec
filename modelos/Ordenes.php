...
require_once("../config/conexion.php");  
  ...
  /////////////   REGISTRAR ORDEN ///////////////////////////////
  public function registrar_orden($correlativo_op,$paciente,$fecha_creacion,$od_pupilar,$oipupilar,$odlente,$oilente,$marca_aro_orden,$modelo_aro_orden,$horizontal_aro_orden,$vertical_aro_orden,$puente_aro_orden,$id_usuario,$observaciones_orden,$dui,$od_esferas,$od_cilindros,$od_eje,$od_adicion,$oi_esferas,$oi_cilindros,$oi_eje,$oi_adicion,$tipo_lente,$color_varilla,$color_frente,$imagen,$edad,$usuario,$ocupacion,$avsc,$avfinal,$avsc_oi,$avfinal_oi,$telefono,$genero,$user,$depto,$municipio){
    ...
    $sql->bindValue(35, $depto);
    $sql->bindValue(36, $municipio);
    $sql->execute();
   ...
   ////////////////////LISTAR ORDENES///////////////
public function editar_orden($correlativo_op,$paciente,$fecha_creacion,$od_pupilar,$oipupilar,$odlente,$oilente,$marca_aro_orden,$modelo_aro_orden,$horizontal_aro_orden,$vertical_aro_orden,$puente_aro_orden,$id_usuario,$observaciones_orden,$dui,$od_esferas,$od_cilindros,$od_eje,$od_adicion,$oi_esferas,$oi_cilindros,$oi_eje,$oi_adicion,$tipo_lente,$color_varilla,$color_frente,$categoria_lente,$imagen,$edad,$usuario,$ocupacion,$avsc,$avfinal,$avsc_oi,$avfinal_oi,$telefono,$genero,$depto,$municipio){
  $conectar = parent::conexion();
  ...
  $edit_ord->bindValue(29, $correlativo_op);
  ...
  public function get_ordenes_filter_date($inicio,$fin,$usuario){
    $conectar= parent::conexion();
    $sql= "select*from orden_lab where (fecha between ? and ?) and usuario=? order by fecha DESC;";
    $sql=$conectar->prepare($sql);
 ...
 ////////////////////////////////flitrar por fecha    ////
  public function get_ordenes_por_enviar($inicio,$fin,$usuario){
      $conectar = parent::conexion();
      ...
      from
      orden_lab as o inner join rx_orden_lab as rx on o.codigo=rx.codigo where o.estado='0' and fecha between ? and ? and_usuario=? order by o.fecha ASC;";
      $sql=$conectar->prepare($sql);
      $sql->bindValue(1,$inicio);
      $sql->bindValue(2,$fin);
      $sql->bindValue(3,$usuario);
...
/////////////////////////////FILTRAR POR LENTE ///////////////////
  public function ordenEnviarLente($lente,$usuario){
      $conectar = parent::conexion();
      $sql = "select o.id_orden,o.codigo,o.paciente,o.fecha,o.pupilar_od,o.pupilar_oi,o.lente_od,o.lente_oi,o.marca_aro,o.modelo_aro,o.horizontal_aro,o.vertical_aro,o.puente_aro,o.usuario,o.observaciones,o.dui,o.estado,o.tipo_lente,rx.od_esferas,rx.od_cilindros,rx.od_eje,rx.od_adicion,rx.oi_esferas,rx.oi_cilindros,rx.oi_eje,rx.oi_adicion
      from
      orden_lab as o inner join rx_orden_lab as rx on o.codigo=rx.codigo where o.estado='0' and o.tipo_lente=? and usuario=? order by o.fecha ASC;";
      $sql=$conectar->prepare($sql);
...
public function ordenEnviarFechaLente($inicio,$fin,$lente,$usuario){
  $conectar = parent::conexion();
  $sql = "select o.id_orden,o.codigo,o.paciente,o.fecha,o.pupilar_od,o.pupilar_oi,o.lente_od,o.lente_oi,o.marca_aro,o.modelo_aro,o.horizontal_aro,o.vertical_aro,o.puente_aro,o.usuario,o.observaciones,o.dui,o.estado,o.tipo_lente,rx.od_esferas,rx.od_cilindros,rx.od_eje,rx.od_adicion,rx.oi_esferas,rx.oi_cilindros,rx.oi_eje,rx.oi_adicion
      from
      orden_lab as o inner join rx_orden_lab as rx on o.codigo=rx.codigo where o.estado='0' and o.tipo_lente=? and fecha between ? and ?  and usuario=? order by o.fecha ASC;";
  $sql=$conectar->prepare($sql);
  $sql->bindValue(1,$lente);
...
public function getTablasRectificaciones($codigoOrden){
  ...
  foreach ($resultado as $key) {
    ...
    <tr>
      ...
      <td colspan='30' class='stilot1'>".$key["marca_aro"]."</td>
