...
<?php require_once("links_plugin.php"); 
 ...
 //('../modales/aros_en_orden.php');
 //require_once('../modales/filtrar_lentes.php');
...
<!-- top-bar -->
  ...
  <div class="content-wrapper">
    ...
    <!--CCCC-->
      <div class="card card-dark card-outline" style="margin: 2px;margin-top: 0px !important">
      <h5 style="text-align: center; font-size: 18px" align="center" class="bg-dark">ORDENES PROCESANDO <span id="lab_act" style="text-transform: uppercase;"></span></h5>
        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
          <li class="nav-item">
            <select name="" id="cat_lente" class="form-control" style="margin-top: 1px">
          ...
          <li class="nav-item">
            <select name="" id="tipo_lente_report" class="form-control" style="margin-top: 1px">
          ...
          <li class="nav-item">
            <input type="date" class="form-control clear_orden_i" id="desde_table" placeholder="desde">
          </li>
          <li class="nav-item" style="display: inline-flex;">
            <input type="date" class="form-control clear_orden_i" id="hasta_table" placeholder="desde"><i class="fas fa-times-circle" style="margin-top: 9px" onClick="clear_input_date()"></i>
          </li>
          <li class="nav-item">
            <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true" onClick="get_ordenes_env('Lomed')">Lomed</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false" onClick="get_ordenes_env('Jenny')">Jenny</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="custom-tabs-one-messages-tab" data-toggle="pill" role="tab" aria-controls="custom-tabs-one-messages" aria-selected="false"  onClick="get_ordenes_env('Divel')">Divel</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="custom-tabs-one-messages-tab" data-toggle="pill" aria-controls="custom-tabs-one-messages" aria-selected="false"  onClick="get_ordenes_env('Lenti')">Lenti</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="custom-tabs-one-messages-tab" data-toggle="pill" href="#custom-tabs-one-messages"  onClick="get_ordenes_env('Arce')">Arce</a>
          </li>
          <li class="nav-item" onClick="showTablas()">
            <a class="nav-link"><i class="fas fa-table" style="color: green;cursor:pointer;" onClick="showTablas()"></i></a>
          </li>
          <!--<li class="nav-item">
            <a class="nav-link"><i class="fas fa-print" style="color: blue;cursor:pointer;" onClick="print_orden_alert()"></i></a>            
          </li>-->
          <li class="nav-item">
             <a class="nav-link"><i class="fas fa-print" style="color: green;cursor:pointer;" onClick="print_orden_alert_multiple()"></i></a>
          </li>
        </ul>
